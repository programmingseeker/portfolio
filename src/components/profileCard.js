...
function ProfileCard() {
  ...
  const [cardState, setCardState] = useState("is-active")
  ...
  useEffect(() => {
    ...
    card = card
    buttons = buttons
  }, [sections, card, buttons])

  const handleButtonClick = e => {
    const targetSection = e.target.getAttribute("data-section")
    const section = document.querySelector(targetSection)
    targetSection !== "#about" ? setCardState("is-active") : setCardState("")
  ...
  return (
    <>
      <div className={`profileCard ${cardState}`} data-state="#about">
        <div className="card-header">
          <div className="card-avatar">
            <Image customer={1} alt="avatar" className="profile-photo" />
          </div>
          <h1 className="card-fullname">Gaurav S Rao</h1>
